...
!   tafislib        ! library name for adoption of nubar values (none[default], endfb8.1, jeff3.3, jendl5.0)
!   taneslib        ! library name for adoption of FNS (none[default], endfb8.1, jeff3.3, jendl5.0)
